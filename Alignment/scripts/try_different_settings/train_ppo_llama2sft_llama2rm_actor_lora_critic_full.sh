deepspeed --module openrlhf.cli.train_ppo \
  ...
  --save_path ../checkpoint/llama2sft-llama2rm-rlhf-actor-lora-critic-full \
  --ckpt_path  ../ckpt/llama2sft-llama2rm-rlhf-actor-lora-critic-full \
  --save_steps 10 \
  --max_ckpt_num 500 \
  --logging_steps 1 \
  --eval_steps -1 \
  ...
  --wandb_run_name try_llama2sft-llama2rm-rlhf-actor-lora-critic-full