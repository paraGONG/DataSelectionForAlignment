deepspeed --module openrlhf.cli.train_ppo \
  ...
  --wandb_project try_tinyllamasft-tinyllamarm-rlhf-actor-lora-llr-critic-lora-llr \
  --wandb_run_name try_tinyllamasft-tinyllamarm-rlhf-actor-lora-llr-critic-lora-llr